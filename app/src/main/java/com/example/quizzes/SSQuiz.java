...
import com.example.quizzes.Model2.GKQuestion;
...
public class SSQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ssquiz);
    ...
    private void updateQuestion() {
        ...
        if (total > 20)
        {
            ...
            Intent ir = new Intent(SSQuiz.this,CSResult.class);
        ...
        else
        {
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    final GKQuestion question;
                    question = snapshot.getValue(GKQuestion.class);
    ...
    public void reverseTimer(int Seconds,final TextView tv){
        ...
        new CountDownTimer(Seconds* 1000+1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent myIntent = new Intent(SSQuiz.this,CSResult.class);
